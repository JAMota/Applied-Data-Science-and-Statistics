...
```
As we can see from the newly updated variogram 
...
We will first start with the default Matrén = 0,5 which is equivalent to an exponential and from there we will try different models to search for the model with the best fit.
