...
We can see that for ACF OF Average strength slowly decreases as lag increases to infinity, meaning it is not a simple AR model.
...
```
## todo get better wording for relevance interval
