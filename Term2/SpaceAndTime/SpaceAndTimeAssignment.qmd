...
## lastly we will use auto.arima without seasonality to comfirm our inital assumptions
...
```
The function does comfirm our assumption that ARIMA(2,0,0) is indeed the best model.

We will now check the residuals to verify if any of ou rpreviously selected model validates well or if it is simply the best of bad models.
