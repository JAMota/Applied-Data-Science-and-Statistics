...
The function does not support continuous priors directly so we will use discrete priors after approximating them to a continuous one using a grid of support points.
