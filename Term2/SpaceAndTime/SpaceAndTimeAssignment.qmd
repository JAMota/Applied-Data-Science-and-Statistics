...
krigeBayesModelWithNugget <- krige.bayes(geodata = precipitationNetherland_geoR, loc = ex.grid, prior = prior.control(phi.prior = phi_probs, phi.discrete = phi_discrete, tausq.rel.prior = tau_sq_rel_probs, tausq.rel.discrete = tau_sq_rel_discrete))


krigeBayesModelWithoutNugget <- krige.bayes(geodata = precipitationNetherland_geoR, loc = ex.grid,
                        prior =  prior.control(phi.prior = phi_probs, phi.discrete = phi_discrete))
