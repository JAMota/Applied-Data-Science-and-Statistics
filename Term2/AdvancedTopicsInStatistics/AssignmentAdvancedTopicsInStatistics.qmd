...
The variable X1 also seems to follow a normal distribution that has a very prolonged skewness to the left and mean 0,5.0
...
p <- ggplot(data = test, aes(x = X1, y = X2, color = correct_prediction)) + geom_point()

# add labels and legend
p <- p + xlab("X1") + ylab("X2") + ggtitle("KNN Classification Results") + scale_color_manual(values = c("red", "blue"), labels = c("Incorrect", "Correct"))
