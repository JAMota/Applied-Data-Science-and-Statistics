...
# # Compile model
# model <- jags.model(textConnection(model_string), data = list(r = surgicalDF$r, n = surgicalDF$n))
# 
# 
# # MCMC sampling
# samples <- coda.samples(model, variable.names = params, n.iter = 10000, n.chains = 2, thin = 1)
# 
# # Discard burn-in
# burn_in <- 5000
# samples <- window(samples, start = burn_in + 1)
