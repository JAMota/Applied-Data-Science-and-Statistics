...
## initial values
inits1 <- list('sigma' = 10, 'theta' = c(-5, -5, -5))
inits2 <- list('sigma' = 50, 'theta' = c(5, 5, 5))
...
jags.mod.fit.infantDeath <- jags(
  data = jags.data.infantDeath,
  inits = jags.inits,
  parameters.to.save = jags.param.infantDeath,
  n.chains = 2,
  n.iter = 10000,
  n.burnin = 5000,
  n.thin = 1,
