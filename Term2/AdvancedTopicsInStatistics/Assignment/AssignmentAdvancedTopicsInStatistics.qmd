...
We will first start by gathering the previous posteriors to use as the new model priors since these values should be better informed about the data than the previous values.
