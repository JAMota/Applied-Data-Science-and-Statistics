...
Udeni ∼ N (μi, σ2) μi = b0 + b1(LeftGi − LeftG) + b2(LabFi − LabF) +
b3(IndCi − IndC) with vague priors 1/σ2 ∼ Gamma(0.001, 0.001) b0 ∼ N (0,
100000) b1 ∼ N (0, 100000) b2 ∼ N (0, 100000) b3 ∼ N (0, 100000)
...
it does not change anything because JAGS will centre automatically to
boost convergence

## Exercise 3

When we want to set up different priors we have to set them manually and
cannot use the foor loop
