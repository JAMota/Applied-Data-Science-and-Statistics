...
As we can from the model, temperature is still statistically significant and but is only capable of justifying 1 to 2% variation of catches due to the lack of variation of temperature to infer on any of the sharp changes in cod landings.
...
Due to lacking of readily available data it will not be possible to make meaningful comparisons with the previous analysis, furthermore primary data collection would be beyond the scope of this project.
