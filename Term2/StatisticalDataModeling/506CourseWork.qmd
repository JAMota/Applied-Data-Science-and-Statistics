...
From the graph data we can see that when x -> 1 y is approximately 210 and as x -> 0 y is approximately to 45
...
# Estimating the MLE
out <- nlm(myLike,
  p = c(210,0.01,15), #the values seem to vary by around 15 units, ##the professor said theta2 needs to be lower so the other values should be alright
  hessian = T,
  iterlim = 10000,
  steptol = 1e-10)
