...
muPoisson_upper = (predPoisson$fit+qnorm(1-1.96/2)*predPoisson$se.fit) ##exp(p$fit+qnorm(1-a/2)*p$se.fit)
muPoisson_lower = (predPoisson$fit-qnorm(1-1.96/2)*predPoisson$se.fit) ## this is the log ver in that was in cheat, ask if this is the correct way since we have a link function or I am just bad
