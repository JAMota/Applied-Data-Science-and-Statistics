...
= $\Pi^n_{i=1} (2\pi\sigma^2)^{-\frac{1}{2}}* e^{(-\frac{1}{2} * \frac{xi - \mu}{\sigma^2})}$ =

= $(2\pi\sigma^2)^{-\frac{n}{2}} * e^{(-\frac{1}{2\sigma^2}* \sum_{i=1}^{n} (xi-\mu)^2)}$
...
= $(2\pi\sigma^2)^{-\frac{100}{2}} * e^{(-\frac{1}{2\sigma^2}* \sum_{i=1}^{100}(xi-\frac{\theta1xi}{\theta2+xi})^2)}$
...
= $ln((2\pi\sigma^2)^{-\frac{n}{2}} * e^{(-\frac{1}{2\sigma^2}* \sum_{i=1}^{n} (xi-\mu)^2)})$ =

= $ln((2\pi\sigma^2)^{-\frac{n}{2}}) + ln(e^{(-\frac{1}{2\sigma^2}* \sum_{i=1}^{n} (xi-\mu)^2)})$ =
