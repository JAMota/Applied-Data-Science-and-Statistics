...
arrival_times_filtered = 1/mean(inter_arrival_times_filtered)

service_time_mu_filtered = 1/mean(heartResultFiltered$queue_service_time)

traffic_intensity_rho_filtered=arrival_times_filtered/service_time_mu_filtered

# Perform the MLE
start_filtered <- c(traffic_intensity_rho_filtered=arrival_times_filtered/service_time_mu_filtered)
  # initial value for rho
...
start_performance <- c(traffic_intensity_rho_performance=arrival_times_performance/service_time_mu_performance)
  # initial value for rho
result_performance <- maxLik(logLike, start=start_performance, x=arrival_times_performance)
...
##Improving performance
inter_arrival_times_performance = inter_arrival_times_performance 

arrival_times_performance = 1/mean(inter_arrival_times_performance)
...
start_producer <- c(rhoProducer = lambdaProducer / muProducer)
  # initial value for rho
result_producer <- maxLik(logLike, start=start_producer, x=lambdaProducer)

# Print the result
print(summary(result_producer))
