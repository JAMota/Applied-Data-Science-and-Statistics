...
#January_2013GroupedClusterAverageVertical = tail(January_2013GroupedClusterAverageVertical, -1)
...
January_2013GroupedClusterAverageVertical$timeIntervals = "0:00"
...
## I created this data frame with the time intervals because it is easier for me mentaly to then add them to the dataframe for plotting 
...
for (i in 1:nrow(January_2013GroupedClusterAverageVertical)) {
  
  January_2013GroupedClusterAverageVertical$timeIntervals[i] = 1
  
}

#ggplot(data = January_2013GroupedClusterAverageVertical, aes(x = id , y = cluster1) +
#         geom_line()
#       )
...
January_2013GroupedClusterAverageVertical
