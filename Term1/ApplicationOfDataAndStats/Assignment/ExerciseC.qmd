...
I have use the following clustering methodology for each year:
  ...
  Clustering Method 5: With the data already distributed through my 4 cluster I did some extra wranglying on the data to be able to plot each cluster power demand 
...
Results:
    ...
    Graph 1: [insert a brief description of what the graph represents and the key findings from the analysis]
    Graph 2: [insert a brief description of what the graph represents and the key findings from the analysis]
    Graph 3: [insert a brief description of what the graph represents and the key findings from the analysis]
