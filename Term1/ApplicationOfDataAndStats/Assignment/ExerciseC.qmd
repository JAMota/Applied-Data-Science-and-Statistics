...
Comparing the height between the second division of leafs and any possible further down divisions we can see that there is still a significant height difference. However if we want to make any further divisions we can see that
